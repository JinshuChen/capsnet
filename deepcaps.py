...
# ## CIFAR10
# train_loader = torch.utils.data.DataLoader(datasets.CIFAR10(root='/home/chenjinshu/capsnet/data/CIFAR',train=True,download=False,transform=trans(rotation_range=0.1, translation_range=0.1, zoom_range=(0.1, 0.2))),batch_size=batch_size,shuffle=True)
# test_loader = torch.utils.data.DataLoader(datasets.CIFAR10(root='/home/chenjinshu/capsnet/data/CIFAR',train=False,download=False,transform=transforms.ToTensor()),batch_size=batch_size,shuffle=True)
